...
public class EquipmentModel
{
	...
	{ // <Mod>
		...
		if (this.owner is AgentModel && this.metaInfo.type == EquipmentTypeInfo.EquipmentType.WEAPON) {
			if (EquipmentTypeInfo.NonScaleWeaponIds.Contains(this.metaInfo.id)) {
	...
	{ // <Mod>
		...
		if (this.metaInfo.id == 230905 || this.metaInfo.id == 330905)
		{
			return true;
		}
    ...
    public int GetUpgradeRisk
	{
		get
		{
			if (EquipmentTypeInfo.BossIds.Contains(this.metaInfo.id)) {
				return 6;
			}
